snipe("!article")[0].reset(
    $("section").add(
        ...
        $("form", {"id":"mmap-tools"}).add(
            $("input", {"type":"button", "style":"width:40%;background-image:url('/resource/img/icon/favorite.png');background-color:rgba(180, 180, 180, 0.3)", "value":"링크"}),
            $("input", {"type":"button", "style":"width:40%;background-image:url('/resource/img/icon/library.png');", "value":"메모"}),
            $("input", {"type":"text", "style":"background-image:url(/resource/img/icon/favorite.png)", "placeholder":"주소", "required":null}),
            $("textarea", {"id":"mmemo", "style":"display:none", "spellcheck":"false", "placeholder":"공백을 저장하면, 해당 메모가 삭제됩니다."}),
            $("input", {"type":"button", "style":"width:40%;background-image:url('/resource/img/icon/del.png');display:none", "value":"메모 클리어"}),
            $("input", {"type":"submit", "style":"width:40%;background-image:url('/resource/img/icon/save.png');display:none", "value":"저장"})
        ),
        $("ul", {"id":"mlink"}),
    )
)
scan("!#mmap-tools input")[0].onclick = e => {
    linkmode = true;
...
scan("!#mmap-tools input")[1].onclick = e => {
    linkmode = false;
